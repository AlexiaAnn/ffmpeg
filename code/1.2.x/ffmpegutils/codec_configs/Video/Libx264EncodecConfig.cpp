...
AVCodecContext* Libx264EncodecConfig::GetContext() {
	...
	av_log_info("trying config libx264 encoder...");
	...
	if (ret < 0)
	{
		av_log_error("could not open libx264 encoder\n");
		return nullptr;
	}
	av_log_info("config libx264 encoder success\n");
	return context;
}

Libx264EncodecConfig::~Libx264EncodecConfig()
{
}
