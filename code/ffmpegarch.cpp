...
int main()
{
	...
	const char *srcFilePath = "f:/videos/record.mp4";
	const char *dstFilePath = "f:/audiotest/record.mp4";
	const int width = 288;
	...
	av_log_info("duration secondes:%f\n", component.GetDuration());
	component.GetSomeInformation();
	/*for (float i = 0; i <= 1; i += 0.02) {
		component.GetFrameDataByPercent(i,nullptr,0);
	}*/
	...
	component.GetFrameDataByPercent(0.2, nullptr,0);
