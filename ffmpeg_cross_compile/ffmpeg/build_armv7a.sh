...
#so file output dir
HOME=/home/pc
OUTPUT=libffmpeg_android_r21e_mediacodec_libmp3lame_arm
...
function build
{
  ...
  --extra-cflags="-Os -fpic -I$COMPILE_MP3_PATH/include $OPTIMIZE_CFLAGS $COMPILE_MEDIA_SO_INCLUDE" \
  --extra-ldflags="-L$COMPILE_MP3_PATH/armeabi-v7a -L$COMPILE_MEDIA_SO_LIB"
